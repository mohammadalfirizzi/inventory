...
if (isset($_GET['nik'])) {
    ...
    $sql = "SELECT * FROM data_motor WHERE nik=$nik";
                    ...
                    <div class="row" >
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="nik" class="form-control" id="nik" placeholder="Masukkan Nomor Induk Kependudukan" value="<?=$data['nik']?>" <?=$attrNik?>>
                            </div>
                            <div class="form-group">
                                <label for="plat">Plat Motor</label>
                                <input type="text" name="plat" class="form-control" id="plat" placeholder="Masukkan Nomor Plat Motor" value="<?=$data['plat']?>">
                            </div>
                            <div class="form-group">
                                <label for="pemilik">Pemilik</label>
                                <input type="text" name="pemilik" class="form-control" id="nik" placeholder="Masukkan Nama Pemilik" value="<?=$data['pemilik']?>">
                            </div>
                            <div class="form-group">
                                <label for="merk">Merk Sepeda Motor</label>
                                <input type="text" name="merk" class="form-control" id="merk" placeholder="Masukkan Merk Sepeda Motor" value="<?=$data['merk']?>">
                            </div>
                            <div class="form-group">
